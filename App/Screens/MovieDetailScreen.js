...
const MovieDetailScreen = ({route,navigation}) => {
  ...
  return (
    ...
    <View style={{backgroundColor:isDark?colors.dark:colors.white,height:"100%"}}>
      ...
      <CustomButton type="heart" size={40} style={{height:80,width:80}} 
      ...
      <View style={{marginTop:150,margin:20,height:"100%"}}>
        ...
        {moreInfo.genres?.map(genre => 
           <Text style={styles.detail1} key={genre.name}>  {genre.name}   </Text>
        )}
        </Text>
        {moreInfo.tagline? 
        <Text style={{color:"gray",fontSize:20,marginTop:10,letterSpacing:0.8}}>{moreInfo.tagline}</Text>
        :null  
      }
        ...
        <Text style={{color:isDark?colors.white:colors.dark,...styles.recommended}}>User Score</Text>
        ...
        {!movie.first_air_date? 
         <View>
           <Text style={{color:isDark?colors.white:colors.dark,marginTop:10,...styles.recommended}}>Performance in Boxoffice</Text>
        ...
        <Text style={{color:isDark?colors.white:colors.dark,...styles.overviewtitle}}>Overview</Text>
        <Text style={styles.overview}>{moreInfo.overview}</Text>
        
        {casting.length!==0? 
        <View style={styles.recommendations}>
        <Text style={{color:isDark?colors.white:colors.dark,...styles.recommended}}>Castings</Text>
        ...
        {crew.length !== 0 ? 
        <View style={styles.recommendations}>
        <Text style={{color:isDark?colors.white:colors.dark,...styles.recommended}}>Crews</Text>
        <ScrollView horizontal={true}>
        ...
        <ScrollView horizontal={true}>
          ...
          <View style={styles.seasons}>
                     ...
                     <Text style={{color:colors.white,...styles.seasonName}}>{tv.name}</Text>
                     </View>
          ):null}
        </ScrollView>
        </View>}
        ...
        {trailer.length !==0 ?
        <View style={{maxHeight:"100%",...styles.recommendations}}>
        <Text style={{color:isDark?colors.white:colors.dark,marginTop:15,...styles.recommended}}>Trailer</Text>
          <ScrollView horizontal={true}>
          {trailer.map(video =>
        ...
        {moreLikeThis.length !== 0 ? 
         <View style={styles.recommendations}>
         <Text style={{color:isDark?colors.white:colors.dark,...styles.recommended}}>More Like This</Text>
         ...
         {video.length!==0? 
         <View style={{maxHeight:"100%",...styles.recommendations}}>
         <Text style={{color:isDark?colors.white:colors.dark,marginTop:15,...styles.recommended}}>Extras</Text>
           <ScrollView horizontal={true}>
           {video.map(video =>
              <VideoCard key={video.key} title={video.name} url={video.key} />                   
           )}
        ...
        <Text style={{color:isDark?colors.white:colors.dark,...styles.secondaryTitle}}>Source Data From Just Watch</Text>
         ...
         {reviews.length!==0 ? <View style={{marginTop:15}}>
          <Text style={{color:isDark?colors.white:colors.dark,...styles.recommended}}>Reviews</Text>
          <ScrollView horizontal={true}>
          {reviews.map(review =>
...
const styles = StyleSheet.create({
    ...
    overview:{
      color:"gray",
      fontSize:18,letterSpacing:1,lineHeight:24
    },
    recommendations:{
      marginTop:20,
    },
