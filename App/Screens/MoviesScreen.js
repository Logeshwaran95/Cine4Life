...
const MoviesScreen = ({navigation}) => {
  ...
  const Popular = async() => {
    ...
    const response2 = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=${api_key}&language=en-US&page=2`);
    const response3 = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=${api_key}&language=en-US&page=3`);
  ...
  const TopRated = async() => {
    ...
    const response2 = await axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=${api_key}&language=en-US&page=2`);
    const response3 = await axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=${api_key}&language=en-US&page=3`);
  ...
  const Upcoming = async() => {
    ...
    const response2 = await axios.get(`https://api.themoviedb.org/3/movie/upcoming?api_key=${api_key}&language=en-US&page=2`);
    const response3 = await axios.get(`https://api.themoviedb.org/3/movie/upcoming?api_key=${api_key}&language=en-US&page=3`);
    setUpcoming([...response1.data.results.filter(item => item.poster_path!=null),...response2.data.results.filter(item => item.poster_path!=null),...response3.data.results.filter(item => item.poster_path!=null)]);
  }
  const NowPlaying = async() => {
    const response1 = await axios.get(`https://api.themoviedb.org/3/movie/now_playing?api_key=${api_key}&language=en-US&page=1`);
    const response2 = await axios.get(`https://api.themoviedb.org/3/movie/now_playing?api_key=${api_key}&language=en-US&page=2`);
    const response3 = await axios.get(`https://api.themoviedb.org/3/movie/now_playing?api_key=${api_key}&language=en-US&page=3`);
    setNowPlaying([...response1.data.results.filter(item => item.poster_path!=null),...response2.data.results.filter(item => item.poster_path!=null),...response3.data.results.filter(item => item.poster_path!=null)]);
  }
    ...
    <View style={{backgroundColor:dark?colors.dark:colors.light,...styles.container}}>
      ...
      >
        <View style={styles.secondaryHeader}>
          <Text style={{color:dark?colors.white:colors.dark,...styles.secondaryHeaderText}}>Now Playing</Text>
      ...
      <View style={{marginTop:30}}>
        ...
        <Text style={{color:dark?colors.white:colors.dark,...styles.title}}>Latest and Trending</Text>
      ...
      <View style={{marginTop:30}}>
      <View style={styles.titleButtonGrp}>
        <Text style={{color:dark?colors.white:colors.dark,...styles.title}}>Upcoming</Text>
