    ...
    <View style={{backgroundColor:isDark?colors.dark:colors.light,...styles.container}}>
      ...
      renderItem={({item,index})=> {
        ...
        return (
          ...
          <Image source={{uri:`https://image.tmdb.org/t/p/w500${item.backdrop_path}`}} style={{height:height/4,width:width/1.4,zIndex:-2,resizeMode:"contain"}}/>
            <Animated.View style={{marginHorizontal:SPACING,padding:SPACING*2,alignItems:'center',borderRadius:34,backgroundColor:colors.dark,transform:[{translateY}]}}>
              ...
              />
                        <CustomButton type="trash-o" size={30} style={{height:60,width:60,marginTop:30}} 
